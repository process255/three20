...
static const CGFloat kMarginAddX = 15;
static const CGFloat kMarginAddY = 15;
static const CGFloat kMarginAddH = 4;
...
- (void)layoutTextEditor {
    ...
    // add a bit of extra padding to text field.
    CGRect prevFrame = _textView.frame;
    _textView.frame = CGRectMake(prevFrame.origin.x + kMarginAddX,
                                 prevFrame.origin.y + kMarginAddY,
                                 prevFrame.size.width - kMarginAddX*2,
                                 prevFrame.size.height - kMarginAddY*2 + kMarginAddH);
